...
/* Every point price in one place. The guide reads this, so the numbers
   shown to a new user can never drift from what the server charges. */
export const POINT_COSTS = [
  { key: "g_cost_booking", cost: 10 },
  { key: "g_cost_chat",    cost: 5  },
  { key: "g_cost_project", cost: 10 },
];
