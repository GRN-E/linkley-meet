      ...
      <div className="container" style={{ maxWidth: 820 }}>
        ...
        <form className="card mt-m" style={{ padding: 28 }} onSubmit={submit}>
          ...
          <div className="grid grid-2" style={{ gap: 18 }}>
            ...
            <div className="field">
              <label>{t("pj_f_goal")}</label>
              <input type="number" min={0} step={100000} value={form.fundingGoal}
                onChange={(e) => set("fundingGoal", parseInt(e.target.value || "0", 10))} />
              <div className="pcounter">{t("pj_f_goal_hint")}</div>
            </div>
          </div>
